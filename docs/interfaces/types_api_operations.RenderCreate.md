[ordr.js - v4.0.0](../README.md) / [types/api/operations](../modules/types_api_operations.md) / RenderCreate
...
- [skip](types_api_operations.RenderCreate.md#skip)
...
• `Optional` **showPPCounter**: `boolean`
